...
\title[Short Article Title]{BioinfoPhaGen}

\author[1]{Yusen Hou}
\author[1,2$\ast$]{Yanlin Zhang\ORCID{0000-0003-4002-443X}}

\address[1]{\orgdiv{Data Science and Analytics Thrust}, \orgname{Hong Kong University of Science and Technology (Guangzhou)}, \orgaddress{\street{No. 1 Du Xue Road, Nansha District, Guangzhou}, \postcode{511455}, \state{Guangdong}, \country{China}}}
\address[2]{\orgname{Hong Kong University of Science and Technology}, \orgaddress{\street{Clear Water Bay, Kowloon}, \postcode{999077}, \state{Hong Kong}, \country{China}}}

\corresp[$\ast$]{Corresponding author. \href{email:email-id.com}{yanlinzhang@hkust-gz.edu.cn}}
